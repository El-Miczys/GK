...
public class swiatlo extends GLJPanel implements GLEventListener {
    ...
    public void Podstawa(GL2 gl2, int n, int r) {
        ...
        for (int i = 0; i <= n; i++) {
            gl2.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_AMBIENT_AND_DIFFUSE, materials[11], 4);
    ...
    public void Stozek(GL2 gl2, int n, int r, int h) {
        Podstawa(gl2, n, r);
        for (int i = 0; i <= n; i++) {
            gl2.glBegin(GL2.GL_POLYGON);
            gl2.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_AMBIENT_AND_DIFFUSE, materials[11], 8);
            gl2.glVertex3d((double) (r * Math.cos(2 * i * Math.PI / n)), 1,
    ...
    private class MouseHandler extends MouseAdapter {
        ...
        public void mousePressed(MouseEvent evt) {
            ...
            prevX = evt.getX();
            dragging = true;
            swiatlo.this.addMouseMotionListener(this);
        }

        public void mouseReleased(MouseEvent evt) {
            dragging = false;
            swiatlo.this.removeMouseMotionListener(this);
        }
