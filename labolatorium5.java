...
public class labolatorium5 extends GLJPanel implements GLEventListener, KeyListener {

    private static final long serialVersionUID = 1L;

    public static void main(String[] args) {
        JFrame window = new JFrame("Some Objects in 3D");
        labolatorium5 panel = new labolatorium5();
    ...
    private void piramida_sciana(float n, GL2 gl2) {
        float deg = 360 / n;
    ...
    private void piramida_baza(float n, GL2 gl2) {
        float deg = 360 / n;
        gl2.glBegin(GL.GL_TRIANGLE_FAN);
    ...
    private void piramida(float n, float scale, GL2 gl2) {
        gl2.glColor3f(0, 6, (float) 0.5);
        gl2.glScalef(scale, scale, scale);
        gl2.glRotatef(0, 0, 90, 0);
        gl2.glTranslatef(0, 0, -1);

        piramida_sciana(n, gl2);
        piramida_baza(n, gl2);
    }

    private void spirala(int n, float scale, GL2 gl2) {
        gl2.glColor3f(0, 6, (float) 0.5);
        gl2.glScalef(scale, scale, scale);
        gl2.glLineWidth(5);
        gl2.glRotatef(0, 0, 90, 0);
